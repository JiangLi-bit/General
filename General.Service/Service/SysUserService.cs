...
namespace General.Service
{
    public class SysUserService : ISysUserService
    {
        ...
        private IRepositoryBase<SysUser> _sysUserRepository;
        private IRepositoryBase<SysUserToken> _sysUserTokenRepository;


        public SysUserService(IRepositoryBase<SysUser> sysUserRepository,
            IRepositoryBase<SysUserToken> sysUserTokenRepository,
        ...
        /// <returns></returns>
        public (bool Status, string Message, string Token, SysUser User) validateUser(string account, string password, string r,bool isApi=false)
        {
            ...
            if (password.Equals(md5Password, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                _sysUserRepository.DbContext.SaveChangesAsync();
        ...
        void ISysUserService.updateSysUser(SysUser model)
        {
